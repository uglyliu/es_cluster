...
export default class ProcessController {
  ...
  start() {
    ...
    var indexCreate = spawnSync('python', ['-m', 'elastalert.create_index', '--index', 'elastalert_status', '--config', config.get('elastalertConfigPath')], {
    /*zyl modify*/
    ...
    /*zyl add*/
    startArguments.push('--config', config.get('elastalertConfigPath'));
    /*zyl add*/
