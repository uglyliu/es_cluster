...
zyl modify*/
const configFile = 'conf/elastalert-server/config.json';
const devConfigFile = 'conf/elastalert-server/config.dev.json';

const configPath = path.join(require('os').homedir(), configFile);
const devConfigPath = path.join(require('os').homedir(), devConfigFile);
